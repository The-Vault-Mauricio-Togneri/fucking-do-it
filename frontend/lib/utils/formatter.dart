...
class Formatter {
  ...
  static String dayLongMonthMonthYear(DateTime dateTime) => DateFormat.yMMMd(Localized.current.languageCode).format(dateTime);

  static String hoursMinutes(DateTime dateTime) => DateFormat.Hm(Localized.current.languageCode).format(dateTime);
